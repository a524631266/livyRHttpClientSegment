...
@SpringBootTest(classes = { TransmitlayerApplication.class })
public class TestRHttpClient {
    ...
    public void startTest() throws IOException, URISyntaxException, InterruptedException {
        ...
        code.append("library(featen)").append("\nlibrary(jsonlite)").append("\nan_start = \"2019/11/14\"").append(
                ...
                .append("\nVData = Data_history$historydataDataFrame").append("\ncache(VData)")
                ...
                .append("\nstime_ana = historyendtime - 7 * 24 * 60* 60").append("\netime_ana = historyendtime")
                .append("\nsensorname = \"IC\"").append("\nresult_2_5 <- Feature_2_5(MData,Sensor,stime_ana,etime_ana)")
                .append("\ncreateOrReplaceTempView(result_2_5, \"result_2_5\")")
                .append("\nresult<-toJSON(collect(sql(\"select time,result from result_2_5\")))")
                .append("\nreturn(result)");
        // .append("\nreturn(collect(result_2_5))");
        // .append("\nreturn(toJSON(collect(result)))");
